...
const Monstruo = ({monstruo}) => {
    ...
    const { id_monstruo, nombre_monstruo, nivel_amenaza, habilidad, mutacion } = monstruo
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p className="font-bold uppercase text-indigo-600 my-2">Mutación: <span className="font-normal normal-case text-black">{mutacion}</span></p>
